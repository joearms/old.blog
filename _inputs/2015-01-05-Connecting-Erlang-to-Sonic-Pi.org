...
title: Connecting Erlang to the SonicPi
@md:content

Last September after giving [[https://www.youtube.com/watch?v=lKXe3HUG2l4][my keynote at StrangeLoop]] I bumped into my
old friend [[https://twitter.com/@samaaron][Sam Aaron]]. As usual he was bubbling over with enthusiasm,
he'd been making a music program for kids [[http://sonic-pi.net/][Sonic Pi]] which interested
me.

I'm interested in all things musical and especially making noises with computers
so I was _very_ interested in Sonic Pi.

My first thought was ``how can I control Sonic Pi from Erlang?'' --
...
a library at [[https://github.com/mujaheed/erlang-osc][erlang-osc]].

The rest was easy.

I'd completely forgotten about this until earlier today when
[[https://twitter.com/@WadeMealing][@WadeMeadling]] tweeted me asking if the code was documented
anywhere. Well it wasn't and now it is.
 
I've put the code up at [[https://github.com/joearms/sonic_pi_interface][sonic_pi_inteface]] it's been tested with sonic
...
__Actually this is not quite true__ It took me ten minutes after Sam
...
This practise (shared memory) comes from the days when efficiency
